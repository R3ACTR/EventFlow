        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-1">
              Configure your hackathon, rules, and tracks
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Participants must register before this date.
                </p>
              </div>
              <div className="md:col-span-2">
                {/* Location Input */}
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Where the event will take place (leave empty for virtual
                  events).
                </p>
              </div>
            </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-2">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Set limits for team composition
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                />
                <p className="text-xs text-slate-400 mt-1">
                  Minimum participants required per team
                </p>
              </div>
              <div>
                <Label className="mb-2 block text-sm font-semibold text-slate-700">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-2">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Categorize projects (e.g., Healthcare, EdTech)
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              {tracks.length === 0 ? (
                <div className="text-center py-6 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                  <p className="text-sm text-slate-500">
                    No tracks added yet. Add one above.
                  </p>
                </div>
              ) : (
                <div className="flex flex-wrap gap-2">
                  {tracks.map((track, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 border border-indigo-100 text-indigo-700 rounded-full text-sm font-medium"
                    >
                      {track}
                      <button
                        type="button"
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-2">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Set the boundaries for participants
                </p>
              </div>
            </div>
